...
import static com.moon.enums.StatusCodeEnum.*;
/**
 * 全局异常拦截
 *
 * @author:Y.0
...
public class GlobalExceptionHandler {
    ...
    public Result<?> handlerNotLoginException(NotLoginException e) {
        ...
        // 返回给前端
        return Result.error(UNAUTHORIZED.getCode(), message);
    }
    ...
    public Result<?> handleSystemException() {
        return Result.error(SYSTEM_ERROR.getCode(), SYSTEM_ERROR.getMsg());
    }
    ...
    public Result<?> handleDisableServiceExceptionException() {
        return Result.error("此账号已被禁止访问服务");
    }
